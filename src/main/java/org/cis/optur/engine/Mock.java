...
import org.apache.commons.InitialSolutionResult;
import org.apache.commons.OptimationResult;
            ...
            do {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    ...
                    if (resul == JOptionPane.OK_OPTION) {
                        ...
                        OptimationResult optimationResult = sn.TSAR(vInitialtemp, vCoolingRate, vIteration,vTabuListLength,vPenaltyRecordRange, vReHeatRange, vReHeatRate);
